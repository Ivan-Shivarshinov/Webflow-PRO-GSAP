document.addEventListener('DOMContentLoaded', function () {
    ...
    mm.add("(max-width: 375px)", () => {
        ...
        //Пятая секция
        const projectsSection = document.querySelector('.section.is-projects');
        const splitTypeProjects = new SplitType('#body-large-projects-split')
        ...
        gsap.set('.link-wrapper', {
            autoAlpha: 0,
            yPercent: 25,
            filter: 'blur(0.3rem)'
        })

        ScrollTrigger.batch('.link-wrapper', {
            onEnter: batch => gsap.to(batch, {
                autoAlpha: 1,
                yPercent: 0,
                filter: 'blur(0rem)',
        ...
        gsap.set('.projects_container .link-wrapper', { display: 'none' });
        gsap.set(document.querySelectorAll('.projects_container .link-wrapper:nth-child(-n+3)'), { display: 'block' });
        gsap.set('#show-less', { display: 'none' });
        ...
        showMoreBtn.addEventListener('click', () => {
            let hiddenProjects = document.querySelectorAll('.projects_container .link-wrapper:not([style*="display: block"])');
        ...
        showLessBtn.addEventListener('click', () => {
            let allProjects = document.querySelectorAll('.projects_container .link-wrapper');
            let projectsToHide = Array.from(allProjects).slice(3);

            projectsToHide.forEach(project => project.style.display = 'none');
        ...
        ScrollTrigger.batch('#footer-link-left', {
            onEnter: batch => gsap.to(batch, {
                autoAlpha: 1,
                x: '0rem',
                scale: 1,
        ...
        ScrollTrigger.batch('#footer-link-right', {
            onEnter: batch => gsap.to(batch, {
                autoAlpha: 1,
                x: '0rem',
                scale: 1,
        ...
        ScrollTrigger.batch('#footer-link-center', {
            onEnter: batch => gsap.to(batch, {
                autoAlpha: 1,
                y: '0rem',
                scale: 1,
        ...
        ScrollTrigger.batch('#footer-btn-center', {
            onEnter: batch => gsap.to(batch, {
                autoAlpha: 1,
                y: '0rem',
                scale: 1,
        ...
        animationFooterBottom
            .from('.footer_links-bottom-wrapper>.btn-white', {
                autoAlpha: 0,
                y: '-5rem',
                scale: 1.5,
                filter: 'blur(0.3rem)',
        ...
        animationMenu
            .fromTo('.burger-strip-three', { rotate: 0, y: '0rem' }, { rotate: 45, y: '-0.3rem', duration: 0.5, ease: ease })
            .fromTo('.burger-strip-one', { rotate: 0, y: '0rem' }, { rotate: -45, y: '0.3rem', duration: 0.5, ease: ease }, '<')
            .fromTo('.burger-strip-two', { autoAlpha: 1 }, { autoAlpha: 0, duration: 0.5, ease: ease }, '<')
            .from('.menu', { autoAlpha: 0, yPercent: -100, duration: duration, ease: ease }, '<')
            .from('.menu_h2-wrapper', { autoAlpha: 0, y: '10rem', stagger: 0.1, duration: duration, ease: 'back.out(2)' }, '-=0.5')
            .from('.body-small.is-menu', { autoAlpha: 0, y: '10rem', duration: duration, ease: 'back.out(2)' }, '-=1');
